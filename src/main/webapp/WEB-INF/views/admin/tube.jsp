	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav ">
				...
				<li class="active"><a href="/admin/tube<custom:allParams/>">Тубус</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/tube" method="GET"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/tube"
					method="POST" modelAttribute="tube" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/tube/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
...
<c:forEach items="${page.content}" var="tube">
	<div class="row">
		<div class="col-md-2 col-xs-2">
			<img src="/images/tube/${tube.id}.jpg?version=${tube.version}"
				width="150" alt="motherInLaw">
		</div>
		<div class="col-md-2 col-xs-2 text-center">${tube.name}</div>
		<div class="col-md-1 col-xs-1 text-center">${tube.price}</div>
		<div class="col-md-3 col-xs-3">${tube.description}</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-warning"
				href="/admin/tube/update/${tube.id}<custom:allParams/>">update</a>
		</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-danger"
				href="/admin/tube/delete/${tube.id}<custom:allParams/>">delete</a>
		</div>
	</div>
</c:forEach>
<div class="row">
