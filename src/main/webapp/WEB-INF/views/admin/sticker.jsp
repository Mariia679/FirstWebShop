	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/admin/sticker<custom:allParams/>">Наклейка</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/sticker" method="GET"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/sticker"
					method="POST" modelAttribute="sticker"
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/sticker/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
...
<c:forEach items="${page.content}" var="sticker">
	<div class="row">
		<div class="col-md-2 col-xs-2">
			<img
				src="/images/sticker/${sticker.id}.jpg?version=${sticker.version}"
				width="150" alt="Sticker">
		</div>
		<div class="col-md-2 col-xs-2 text-center">${sticker.name}</div>
		<div class="col-md-1 col-xs-1 text-center">${sticker.price}</div>
		<div class="col-md-3 col-xs-3">${sticker.description}</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-warning"
				href="/admin/sticker/update/${sticker.id}<custom:allParams/>">update</a>
		</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-danger"
				href="/admin/sticker/delete/${sticker.id}<custom:allParams/>">delete</a>
		</div>
	</div>
</c:forEach>
<div class="row">
