	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/admin/country<custom:allParams/>">Страна</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/country" method="GET"
				...
				<form:form class="form-horizontal" action="/admin/country"
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/country/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/country/update/${country.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/country/delete/${country.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
