	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="/admin/ringBumper<custom:allParams/>">Бондажное кольцо
						бампера</a><span class="sr-only">(current)</span></li>
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/ringBumper" method="GET"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/ringBumper"
					method="POST" modelAttribute="ringBumper">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/ringBumper/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="ringBumper">
			<div class="row">
				<div class="col-md-4 col-xs-4">${ringBumper.name}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/ringBumper/update/${ringBumper.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/ringBumper/delete/${ringBumper.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
