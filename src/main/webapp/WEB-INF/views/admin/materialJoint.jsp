	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="/admin/materialJoint<custom:allParams/>">Материал резьбы</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/materialJoint"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/materialJoint"
					method="POST" modelAttribute="materialJoint">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/materialJoint/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="materialJoint">
			<div class="row">
				<div class="col-md-4 col-xs-4">${materialJoint.name}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/materialJoint/update/${materialJoint.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/materialJoint/delete/${materialJoint.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
