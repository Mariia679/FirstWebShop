	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="/admin/carvingJoint<custom:allParams/>">Вид резьбы</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/carvingJoint"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/carvingJoint"
					method="POST" modelAttribute="carvingJoint">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/carvingJoint/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="carvingJoint">
			<div class="row">
				<div class="col-md-4 col-xs-4">${carvingJoint.name}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/carvingJoint/update/${carvingJoint.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/carvingJoint/delete/${carvingJoint.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
