	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav ">
				...
				<li class="active"><a
					href="/admin/motherInLaw<custom:allParams/>">Тещи для бильярда</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/motherInLaw"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/motherInLaw"
					method="POST" modelAttribute="motherInLaw"
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/motherInLaw/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
...
<c:forEach items="${page.content}" var="motherInLaw">
	<div class="row">
		<div class="col-md-2 col-xs-2">
			<img
		...
		<div class="col-md-2 col-xs-2 text-center">${motherInLaw.name}</div>
		<div class="col-md-1 col-xs-1 text-center">${motherInLaw.price}</div>
		<div class="col-md-3 col-xs-3">${motherInLaw.description}</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-warning"
				href="/admin/motherInLaw/update/${motherInLaw.id}<custom:allParams/>">update</a>
		</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-danger"
				href="/admin/motherInLaw/delete/${motherInLaw.id}<custom:allParams/>">delete</a>
		</div>
	</div>
</c:forEach>
<div class="row">
