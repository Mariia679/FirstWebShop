	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/admin/newMail<custom:allParams/>">Новая
						Почта</a><span class="sr-only">(current)</span></li>
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-horizontal filter" action="/admin/newMail"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/newMail"
					method="POST" modelAttribute="newMail">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/newMail/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="newMail">
			<div class="row">
				<div class="col-md-4 col-xs-4">${newMail.department}</div>
				<div class="col-md-3 col-xs-3">${newMail.city.name}</div>
				<div class="col-md-3 col-xs-3">
					<a class="btn btn-warning"
						href="/admin/newMail/update/${newMail.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-2 col-xs-2">
					<a class="btn btn-danger"
						href="/admin/newMail/delete/${newMail.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
