	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav ">
				...
				<li class="active"><a
					href="/admin/holdersChalk<custom:allParams/>">Держатели мела</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/holdersChalk"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/holdersChalk"
					method="POST" modelAttribute="holdersChalk"
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/holdersChalk/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
...
<c:forEach items="${page.content}" var="holdersChalk">
	<div class="row">
		<div class="col-md-2 col-xs-2">
			<img
		...
		<div class="col-md-2 col-xs-2 text-center">${holdersChalk.name}</div>
		<div class="col-md-1 col-xs-1 text-center">${holdersChalk.price}</div>
		<div class="col-md-3 col-xs-3">${holdersChalk.description}</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-warning"
				href="/admin/holdersChalk/update/${holdersChalk.id}<custom:allParams/>">update</a>
		</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-danger"
				href="/admin/holdersChalk/delete/${holdersChalk.id}<custom:allParams/>">delete</a>
		</div>
	</div>
</c:forEach>
<div class="row">
