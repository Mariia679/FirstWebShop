	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="/admin/mainMaterial<custom:allParams/>">Основной материал</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/mainMaterial"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/mainMaterial"
					method="POST" modelAttribute="mainMaterial">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/mainMaterial/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="mainMaterial">
			<div class="row">
				<div class="col-md-4 col-xs-4">${mainMaterial.name}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/mainMaterial/update/${mainMaterial.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/mainMaterial/delete/${mainMaterial.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
