	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="/admin/methodDelivery<custom:allParams/>">Способ доставки</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/methodDelivery"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/methodDelivery"
					method="POST" modelAttribute="methodDelivery">
					<custom:hiddenInputs excludeParams="title" />
					<div class="form-group">
						...
						<label style="color: red; text-align: left;" for="name"
							class="col-sm-3 control-label"><form:errors path="title" /></label>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-default">Cоздать</button>
							<a class="btn btn-primary" href="/admin/methodDelivery/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="methodDelivery">
			<div class="row">
				<div class="col-md-4 col-xs-4">${methodDelivery.title}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/methodDelivery/update/${methodDelivery.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/methodDelivery/delete/${methodDelivery.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
