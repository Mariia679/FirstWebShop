	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="/admin/typeSticker<custom:allParams/>">Тип наклейки</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/typeSticker"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/typeSticker"
					method="POST" modelAttribute="typeSticker">
					<custom:hiddenInputs excludeParams="name" />
					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">Тип
							наклейки</label>
						<div class="col-sm-7">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/typeSticker/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<c:forEach items="${page.content}" var="typeSticker">
			<div class="row">
				<div class="col-md-4 col-xs-4">${typeSticker.name}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/typeSticker/update/${typeSticker.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/typeSticker/delete/${typeSticker.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
