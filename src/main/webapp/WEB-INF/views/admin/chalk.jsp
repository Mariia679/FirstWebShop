	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav ">
				...
				<li class="active"><a href="/admin/chalk<custom:allParams/>">Мел
						для кия</a><span class="sr-only">(current)</span></li>
...
<div class="row">
	<div class="col-md-3 col-xs-3">
		<form:form class="form-inline" action="/admin/chalk" method="GET"
	...
	<div class="col-md-7 col-xs-6">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/chalk"
					method="POST" modelAttribute="chalk" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a class="btn btn-primary" href="/admin/chalk/cancel">Отменить</a>
						</div>
					</div>
				</form:form>
			</div>
...
<c:forEach items="${page.content}" var="chalk">
	<div class="row">
		...
		<div class="col-md-2 col-xs-2 text-center">${chalk.name}</div>
		<div class="col-md-1 col-xs-1 text-center">${chalk.price}</div>
		<div class="col-md-3 col-xs-3">${chalk.description}</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-warning"
				href="/admin/chalk/update/${chalk.id}<custom:allParams/>">update</a>
		</div>
		<div class="col-md-2 col-xs-2">
			<a class="btn btn-danger"
				href="/admin/chalk/delete/${chalk.id}<custom:allParams/>">delete</a>
		</div>
	</div>
</c:forEach>
<div class="row">
