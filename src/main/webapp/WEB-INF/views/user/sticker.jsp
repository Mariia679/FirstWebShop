...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-3">
			<form:form class="form-inline" action="/sticker" method="GET"
				modelAttribute="filter">
				<custom:hiddenInputs excludeParams="nameSticker, min, max" />
				<div class="all-products">
					<div class="col-sm-12 col-xs-12">
						<form:input path="nameSticker" class="form-control "
							placeholder="Search" />
					</div>
				</div>
				<div class="all-products">
		...
		<div class="all-product">
			<c:forEach items="${page.content}" var="sticker">
				<div class="thumbnail">
					...
					<h3 class="text-center">${sticker.name}</h3>
					<p>Цена ${sticker.price} грн</p>
					<p>
						<a href="/sticker/buy/${sticker.id}" class="btn btn-primary"
							role="button">Купить</a> <a href="/sticker/details/${sticker.id}"
