...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="row name">${motherInLaw.name}</div>
			<img src="/images/mother_in_law/${motherInLaw.id}.jpg?version=${motherInLaw.version}"
				width="300" alt="Here is cue">
			
		</div>
		<div class="col-md-8 col-sm-8 col-xs-12">

			<div class="price">${motherInLaw.price}грн.</div>
			<div class="row indent">
				<a href="/motherInLaw/toBascet/${motherInLaw.id}" class="btn btn-primary"
		...
		<div>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane bascket active" id="profile">
					${motherInLaw.description}</div>
				<div role="tabpanel" class="tab-pane bascket" id="messages">

					<form:form class="form-horizontal"
						action="/user/motherInLawCard/${motherInLaw.id}" method="POST"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<a class="btn btn-primary" href="/user/motherInLawCard/cancel">Отменить</a>
							</div>
						</div>
					</form:form>
