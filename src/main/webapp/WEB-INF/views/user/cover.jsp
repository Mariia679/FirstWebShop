...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-3">
			<form:form class="form-inline" action="/cover" method="GET"
				modelAttribute="filter">
				<custom:hiddenInputs excludeParams="nameTube, min, max" />
				<div class="all-products">
					<div class="col-sm-12 col-xs-12">
						<form:input path="nameTube" class="form-control "
							placeholder="Search" />
					</div>
				</div>
				<div class="all-products">
		...
		<div class="all-product">
			<c:forEach items="${page.content}" var="tube">
				<div class="thumbnail">
					...
					<p>Цена ${tube.price} грн</p>
					<p>
						<a href="/cover/buy/${tube.id}" class="btn btn-primary"
							role="button">Купить</a> <a href="/cover/details/${tube.id}"
