...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-3">
			<form:form class="form-inline" action="/gloves" method="GET"
				modelAttribute="filter">
				<custom:hiddenInputs excludeParams="nameGlove, min, max" />
				<div class="all-products">
					<div class="col-sm-12 col-xs-12">
						<form:input path="nameGlove" class="form-control "
							placeholder="Search" />
					</div>
				</div>
				<div class="all-products">
		...
		<div class="all-product">
			<c:forEach items="${page.content}" var="glove">
				<div class="thumbnail">
					...
					<h3 class="text-center">${glove.name}</h3>
					<p>Цена ${glove.price} грн</p>
					<p>
						<a href="/gloves/buy/${glove.id}" class="btn btn-primary"
							role="button">Купить</a> <a href="/gloves/details/${glove.id}"
