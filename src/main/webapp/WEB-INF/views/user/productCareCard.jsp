...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="row name">${productCare.name}</div>
			<img src="/images/product_care/${productCare.id}.jpg?version=${productCare.version}"
				width="300" alt="Here is cue">
			
		</div>
		<div class="col-md-8 col-sm-8 col-xs-12">

			<div class="price">${productCare.price}грн.</div>
			<div class="row indent">
				<a href="/productCare/toBascet/${productCare.id}" class="btn btn-primary"
		...
		<div>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane bascket active" id="profile">
					${productCare.description}</div>
				<div role="tabpanel" class="tab-pane bascket" id="messages">

					<form:form class="form-horizontal"
						action="/user/productCareCard/${productCare.id}" method="POST"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<a class="btn btn-primary" href="/user/productCareCard/cancel">Отменить</a>
							</div>
						</div>
					</form:form>
