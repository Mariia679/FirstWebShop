...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-3">
			<form:form class="form-inline" action="/productCare" method="GET"
				modelAttribute="filter">
				<custom:hiddenInputs excludeParams="nameProductCare, min, max" />
				<div class="all-products">
					<div class="col-sm-12 col-xs-12">
						<form:input path="nameProductCare" class="form-control "
							placeholder="Search" />
					</div>
				</div>
				<div class="all-products">
		...
		<div class="all-product">
			<c:forEach items="${page.content}" var="productCare">
				<div class="thumbnail">
					...
					<h3 class="text-center">${productCare.name}</h3>
					<p>Цена ${productCare.price} грн</p>
					<p>
						<a href="/productCare/buy/${productCare.id}"
							class="btn btn-primary" role="button">Купить</a> <a
							href="/productCare/details/${productCare.id}"
