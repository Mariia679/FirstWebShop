...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-3">
			<form:form class="form-inline" action="/holdersChalk" method="GET"
				modelAttribute="filter">
				<custom:hiddenInputs excludeParams="nameHoldersChalk, min, max" />
				<div class="all-products">
					<div class="col-sm-12 col-xs-12">
						<form:input path="nameHoldersChalk" class="form-control "
							placeholder="Search" />
					</div>
				</div>
				<div class="all-products">
		...
		<div class="all-product">
			<c:forEach items="${page.content}" var="holdersChalk">
				<div class="thumbnail">
					...
					<h3 class="text-center">${tube.name}</h3>
					<p>Цена ${holdersChalk.price} грн</p>
					<p>
						<a href="/holdersChalk/buy/${holdersChalk.id}"
							class="btn btn-primary" role="button">Купить</a> <a
							href="/holdersChalk/details/${holdersChalk.id}"
