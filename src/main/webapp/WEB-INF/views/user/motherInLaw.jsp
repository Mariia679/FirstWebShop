...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-3">
			<form:form class="form-inline" action="/motherInLaw" method="GET"
				modelAttribute="filter">
				<custom:hiddenInputs excludeParams="nameMotherInLaw, min, max" />
				<div class="all-products">
					<div class="col-sm-12 col-xs-12">
						<form:input path="nameMotherInLaw" class="form-control "
							placeholder="Search" />
					</div>
				</div>
				<div class="all-products">
		...
		<div class="all-product">
			<c:forEach items="${page.content}" var="motherInLaw">
				<div class="thumbnail">
					...
					<h3 class="text-center">${motherInLaw.name}</h3>
					<p>Цена ${motherInLaw.price} грн</p>
					<p>
						<a href="/motherInLaw/buy/${motherInLaw.id}"
							class="btn btn-primary" role="button">Купить</a> <a
							href="/motherInLaw/details/${motherInLaw.id}"
