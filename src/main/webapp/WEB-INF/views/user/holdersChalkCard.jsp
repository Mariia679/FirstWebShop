...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="row name">${holdersChalk.name}</div>
			<img src="/images/holders_chalk/${holdersChalk.id}.jpg?version=${holdersChalk.version}"
				width="300" alt="Here is cue">
			
		</div>
		<div class="col-md-8 col-sm-8 col-xs-12">

			<div class="price">${holdersChalk.price}грн.</div>
			<div class="row indent">
				<a href="/holdersChalk/toBascet/${holdersChalk.id}" class="btn btn-primary"
		...
		<div>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane bascket active" id="profile">
					${holdersChalk.description}</div>
				<div role="tabpanel" class="tab-pane bascket" id="messages">

					<form:form class="form-horizontal"
						action="/user/holdersChalkCard/${holdersChalk.id}" method="POST"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<a class="btn btn-primary" href="/user/holdersChalkCard/cancel">Отменить</a>
							</div>
						</div>
					</form:form>
