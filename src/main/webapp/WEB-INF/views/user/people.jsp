        ...
        <div class="row" ng-show="currentView=='form'">
            <div class="col-sm-6 col-sm-offset-3">
                <form action="" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="" class="control-label col-sm-2">Age</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  ng-model="currentItem.age">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="control-label col-sm-2">Address</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  ng-model="currentItem.address">
                        </div>
                    </div>
                    <div class="form-group">
