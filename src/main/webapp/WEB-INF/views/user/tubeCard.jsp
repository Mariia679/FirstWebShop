...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="row name">${tube.name}</div>
			<img
		...
		<div class="col-md-8 col-sm-8 col-xs-12">
			...
			<div class="price">${tube.price}грн.</div>
			<div class="row indent">
				<a href="/cover/toBascet/${tube.id}"
		...
		<div>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane bascket active" id="profile">
					${tube.description}</div>
				<div role="tabpanel" class="tab-pane bascket" id="messages">

					<form:form class="form-horizontal" action="/user/tubeCard/${tube.id}"
						method="POST" modelAttribute="tubeCard">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<a class="btn btn-primary" href="/user/tubeCard/cancel">Отменить</a>
							</div>
						</div>
					</form:form>
