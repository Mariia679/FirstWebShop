...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="row name">${glove.name}</div>
		...
		<div class="col-md-8 col-sm-8 col-xs-12">
			...
			<div class="price">${glove.price}грн.</div>
			<div class="row indent">
				<a href="/gloves/toBascet/${glove.id}" class="btn btn-primary"
		...
		<div>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane bascket active" id="profile">
					${glove.description}</div>
				<div role="tabpanel" class="tab-pane bascket" id="messages">

					<form:form class="form-horizontal"
						action="/user/gloveCard/${glove.id}" method="POST"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<a class="btn btn-primary" href="/user/gloveCard/cancel">Отменить</a>
							</div>
						</div>
					</form:form>
