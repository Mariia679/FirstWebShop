...
@Controller
@RequestMapping("/user/productCareCard/{chalkId}")
public class ProductCareCardContoller {

	@Autowired
	private ReviewsService reviewsService;

	@Autowired
	private ProductCareService service;
	...
	public String save(Model model, @CookieValue(value = "userId") Long userId,
		...
		reviews.setProductCare(service.findOne(chalkId));
