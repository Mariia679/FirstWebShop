...
@Controller
@RequestMapping("/user/motherInLawCard/{chalkId}")
public class MotherInLawCardController {
	@Autowired
	private ReviewsService reviewsService;

	@Autowired
	private MotherInLawService service;
	...
	public String save(Model model, @CookieValue(value = "userId") Long userId,
		...
		reviews.setMotherInLaw(service.findOne(chalkId));
