...
import ua.com.shop.validator.GloveValidator;

@Controller
@RequestMapping("/admin/glove")
@SessionAttributes("glove")
public class GloveController {
	...
	protected void initBinder(WebDataBinder binder) {
		binder.setValidator(new GloveValidator(gloveService));
	}

	@ModelAttribute("glove")
	public GloveForm getForm() {
		return new GloveForm();
	}
	...
	public String show(Model model, @PageableDefault Pageable pageable,
		...
		model.addAttribute("page", gloveService.findAll(filter, pageable));
	...
	public String update(@PathVariable Long id, Model model,
			...
			@ModelAttribute("filter") SimpleFilter filter,@CookieValue(defaultValue = "0", name = "userId") Long userId) {
		model.addAttribute("glove", gloveService.findForm(id));
	...
	public String delete(@PathVariable Long id,
		...
		gloveService.delete(id);
		return "redirect:/admin/glove" + getParams(pageable, filter);
	}
	...
	@PostMapping
	public String save(@ModelAttribute("glove") @Valid GloveForm glove,
