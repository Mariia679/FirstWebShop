...
import ua.com.shop.validator.GashTypeValidator;

@Controller
@RequestMapping("/admin/gashType")
@SessionAttributes("gashType")
public class GashTypeController {
	...
	protected void initBinder(WebDataBinder binder) {
		binder.setValidator(new GashTypeValidator(gashTypeService));
	}

	@ModelAttribute("gashType")
	public GashType getForm() {
		return new GashType();
	}
	...
	public String show(Model model, @PageableDefault Pageable pageable,
		...
		model.addAttribute("page",
				gashTypeService.findAll(filter, pageable));
	...
	public String update(@PathVariable Long id, Model model,
			...
			@ModelAttribute("filter") SimpleFilter filter,@CookieValue(defaultValue = "0", name = "userId") Long userId) {
		model.addAttribute("gashType", gashTypeService.findOne(id));
	...
	public String delete(@PathVariable Long id,
		...
		commodityService.setNullGashType(id);
		gashTypeService.delete(id);
		return "redirect:/admin/gashType"+ getParams(pageable, filter);
	}
	...
	@PostMapping
	public String save(@ModelAttribute("gashType") @Valid GashType gashType,
