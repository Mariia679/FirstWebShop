...
import ua.com.shop.validator.RingBumperValidator;

@Controller
@RequestMapping("/admin/ringBumper")
@SessionAttributes("ringBumper")
public class RingBumperController {
	...
	@InitBinder("ringBumper")
	protected void initBinder(WebDataBinder binder) {
		binder.setValidator(new RingBumperValidator(ringBumperService));
	}

	@ModelAttribute("ringBumper")
	public RingBumper getForm() {
		return new RingBumper();
	}
	...
	public String show(Model model, @PageableDefault Pageable pageable,
		...
		model.addAttribute("page", ringBumperService.findAll(filter, pageable));
	...
	public String update(@PathVariable Long id, Model model,
			...
			@ModelAttribute("filter") SimpleFilter filter,@CookieValue(defaultValue = "0", name = "userId") Long userId) {
		model.addAttribute("ringBumper", ringBumperService.findOne(id));
	...
	public String delete(@PathVariable Long id,
		...
		commodityService.setNullRingBumper(id);
		ringBumperService.delete(id);
		return "redirect:/admin/ringBumper" + getParams(pageable, filter);
	}
	...
	@PostMapping
	public String save(@ModelAttribute("ringBumper") @Valid RingBumper bumper,
